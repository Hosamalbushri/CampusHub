...
return [
    ...
    'settings' => [
        ...
        'shop-theme' => [
            ...
            'index' => [
                'title' => 'الصفحة الرئيسية للبوابة',
                'info' => 'إدارة أقسام الصفحة العامة (مثل تخصيصات ثيم Bagisto).',
            ...
            'create' => [
                ...
                'type' => [
                    ...
                    'immersive-hero' => 'بطل غامر (نمط Student Sphere)',
                    'portal-footer' => 'تذييل البوابة (كل الصفحات)',
                    'product-carousel-legacy' => 'عرض منتجات (قديم — لا يظهر في البوابة)',
                ],

                'portal-footer-duplicate' => 'يُسمح بتذييل بوابة واحد فقط لكل ثيم. عدّل السجل الحالي أو اختر نوعاً آخر.',
            ],

            'types' => [
                'image_carousel' => 'عرض صور',
                'static_content' => 'محتوى ثابت',
                'event_carousel' => 'عرض فعاليات',
                'category_carousel' => 'تصنيفات الفعاليات',
                'footer_links' => 'روابط تذييل',
                'services_content' => 'شريط الخدمات',
                'immersive_hero' => 'بطل غامر',
                'portal_footer' => 'تذييل البوابة (كل الصفحات)',
            ...
            'edit' => [
                ...
                'portal' => [
                    ...
                    'enabled' => 'استخدام تذييل البوابة في الواجهة',
                    'effects' => 'المؤثرات',
                    'effect' => [
                        'orbs' => 'دوائر متدرجة',
                        'grid' => 'شبكة خفيفة',
    ...
    'configuration' => [
        'index' => [
            ...
            'general' => [
                ...
                'design' => [
                    'title' => 'التصميم',
                    'info' => 'إعدادات شعار لوحة الإدارة منفصلة عن إعدادات واجهة المتجر العامة.',
                    ...
                    'shop-logo' => [
                        ...
                        'logo-image' => 'صورة الشعار',
                        'title' => 'واجهة المتجر',
                        'title-info' => 'الشعار وأيقونة المتصفح وألوان الواجهة الظاهرة للزوار في المتجر والصفحات العامة.',
                    ...
                    'events-page' => [
                        ...
                        'title-info' => 'إدارة العنوان والوصف الظاهرين في صفحة الفعاليات بالمتجر.',
                        'heading' => 'العنوان',
                        'description' => 'الوصف',
                    ],
                ],
                ...
                'store' => [
                    'title' => 'المتجر',
                    'info' => 'إعدادات واجهة المتجر في تبويب منفصل عن إعدادات لوحة الإدارة.',
                    ...
                    'navigation' => [
                        'title' => 'تبويبات التنقل',
                        'title-info' => 'إظهار/إخفاء التبويبات، تعديل أسمائها، وإضافة تبويبات مخصصة في هيدر المتجر.',
    ...
    'layouts' => [
        ...
        'lead' => 'طلب تسجيل',
        'lead-info' => 'إدارة جميع إعدادات طلبات التسجيل الخاصة بك في نظام CRM',
        'pipelines' => 'الأنابيب',
    ...
    'events' => [
        ...
        'create' => [
            ...
            'event-end-date-hint' => 'آخر يوم تبقى فيه الفعالية «متوفرة» (شامل). مطلوب عند تفعيل «الحد بتاريخ الانتهاء».',
            'organizer'       => 'الجهة المنظمة',
            'organizer-placeholder' => 'الجهة أو جهة الاتصال',
            'availability-section' => 'شروط التوفر',
            'availability-section-intro' => 'حدد ما الذي يجعل الفعالية «متوفرة» في المتجر. يمكن الجمع بين المقاعد وتاريخ الانتهاء؛ يجب تحقق كل الشرط المفعّل.',
            ...
            'published-hint'  => 'الفعالية غير المنشورة لا تظهر في المتجر بغض النظر عن شروط التوفر.',
            'name'            => 'اسم الفعالية',
