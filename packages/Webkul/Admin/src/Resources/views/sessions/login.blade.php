<x-admin::layouts.anonymous>
    ...
    <div class="flex h-[100vh] flex-col items-center justify-center gap-10">
        <div class="flex flex-col items-center gap-5">
            ...
            <div class="box-shadow flex min-w-[300px] flex-col rounded-md border border-gray-100 bg-white dark:border-gray-800 dark:bg-gray-900">
                {!! view_render_event('admin.sessions.login.form_controls.before') !!}

                <!-- Login Form -->
                <x-admin::form :action="route('admin.session.store')">
                    <p class="border-s-4 border-[color:var(--brand-color)] p-4 ps-3 text-xl font-bold text-gray-800 dark:border-[color:var(--brand-color)] dark:text-white">
                        @lang('admin::app.users.login.title')
                    </p>
                    ...
                    <div class="flex items-center justify-between p-4">
                        ...
                        <a
                            class="cursor-pointer text-xs font-semibold leading-6 text-[color:var(--shop-accent)] hover:underline"
